...
GATEWAY=192.168.56.1      # vbox gateway
SERVER_IP=192.168.56.188  # k3s server ip
TOKEN=jzk3sdev            # k3s token
HTTP_PROXY=$http_proxy    # k3os http/https proxy

export SERVER_BOX=k3os-common-server
export SERVER_CONF=config-server.yml
export SERVER_VM_NAME=k3s-server
export SERVER_HOST_NAME=k3s-master

export AGENT_BOX=k3os-common-agent
